  ...
  return (
    ...
    >
      <div
        ...
        style={isDesktop ? {} : { minHeight: '48.75rem' }}
      >
        <div className="w-full bg-gradient-to-br from-[#0a1128] via-[#121c33] to-[#0a1128] relative overflow-hidden flex justify-center shrink-0 border-b border-white/[0.05]">
          ...
          <div className={`w-full max-w-[32rem] relative z-10 ${isDesktop ? 'px-6 py-10' : 'px-5 py-8'}`}>
            <div className="flex items-center justify-between gap-4">
              <div className="flex-1">
                <h1 className={`font-extralight text-white m-0 tracking-wide ${isDesktop ? 'text-4xl' : 'text-2xl'}`}>
                  Register as a{' '}
              ...
              <div className={`shrink-0 rounded-[4px] border border-[#d4af37]/20 bg-gradient-to-br from-white/5 to-transparent backdrop-blur-md flex items-center justify-center shadow-[0_0_20px_rgba(212,175,55,0.05)] ${isDesktop ? 'w-14 h-14' : 'w-12 h-12'}`}>
                {userType === 'seller' ? (
        ...
        <div className={`flex-1 flex justify-center ${isDesktop ? 'py-10 px-6' : 'py-6 px-4'} bg-[#fafafb]`}>
          <div className={`w-full ${isDesktop ? 'max-w-[48rem]' : 'max-w-full'}`}>
            <div className="bg-white rounded-[7px] border border-black/[0.03] shadow-[0_20px_40px_-15px_rgba(0,0,0,0.05)] overflow-hidden">
              <div className={` ${isDesktop ? 'px-8 py-8' : 'px-5 py-6'}`}>
                {userType === 'seller' ? (
