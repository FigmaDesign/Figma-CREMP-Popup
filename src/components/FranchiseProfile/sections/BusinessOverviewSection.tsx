      ...
      <div className="flex flex-col gap-2 mt-1">
        ...
        <div className={`grid gap-2 ${isDesktop ? 'grid-cols-2' : 'grid-cols-1'}`}>
          ...
          <div className="flex flex-col">
            <h3 className={`${isDesktop ? 'text-[1.125rem]' : 'text-[0.875rem]'} font-extrabold text-[#0f1f3d] m-0 mb-1 leading-none`}>
              Unique Selling Points
            </h3>
          ...
          <div className="flex flex-col">
            ...
            <div className={`bg-[#f5f6f8] border border-[#eef0f3] rounded px-1 py-0.5 ${isDesktop ? 'text-[1rem]' : 'text-[0.75rem]'} font-bold text-[#1f3b73] leading-[1.4]`}>
